...
const Questions = () => {
  const qaList = [
    {
      q: "Як користуватися застосунком?",
      a: (
        <p>
          - Завантаж застосунок з Google Play <br />- Встанови застосунок на своєму
          телефоні з ОС Android
          <br /> - Зареєструйся як новий користувач застосунку та розкажи про себе
    ...
    {
      q: "Яку відповідальність за моїх дітей несуть розробники застосунку?",
      a: (
        <p>
          - За жодних обставин ми не несемо жодної відповідальності перед
          користувачами застосунку та третіми особами за будь-які збитки чи шкоду
          будь-якого роду, понесені в результаті використання мобільного застосунку
          або будь-якої інформації, наданої в мобільному застосунку. Тому залишаючи
          свою дитину з іншими користувачами застосунку, будь дуже уважною,
    ...
    },
    {
      ...
      a: (
        <p>
          - Користування застосункуом повністю безкоштовно та не лімітовано за
